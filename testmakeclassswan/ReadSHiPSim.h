...
// Fri Jan 14 09:50:00 2022 by ROOT version 6.24/00
// from TTree cbmsim//cbmroot
// found on file: ../file_Martina/Background_Sim_Martina/Background_Sim/nu_mu/elastic/ship.conical.Genie-TGeant4.root
//////////////////////////////////////////////////////////

#ifndef ReadSHiPSim_h
#define ReadSHiPSim_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   static constexpr Int_t kMaxcbmroot_Stack_MCTrack = 128300;
   static constexpr Int_t kMaxcbmroot_veto_vetoPoint = 6733;
   static constexpr Int_t kMaxcbmroot_NuTauMudet_ShipRpcPoint = 1133;
   static constexpr Int_t kMaxcbmroot_Target_TargetPoint = 1;
   static constexpr Int_t kMaxcbmroot_TargetTracker_TTPoint = 3502;
   static constexpr Int_t kMaxcbmroot_Hpt_HptPoint = 2725;
   static constexpr Int_t kMaxcbmroot_strawtubes_strawtubesPoint = 766;
   static constexpr Int_t kMaxcbmroot_Ecal_EcalPoint = 1;
   static constexpr Int_t kMaxcbmroot_EcalLite_EcalPointLite = 44;
   static constexpr Int_t kMaxcbmroot_Hcal_HcalPoint = 1;
   static constexpr Int_t kMaxcbmroot_HcalLite_HcalPointLite = 46;
   static constexpr Int_t kMaxcbmroot_muon_muonPoint = 9;
   static constexpr Int_t kMaxcbmroot_TimeDet_TimeDetPoint = 12;
   ...
   // FairMultiLinkedData vetoPoint_fLink[kMaxcbmroot_veto_vetoPoint];
   ...
   //FairMultiLinkedData ShipRpcPoint_fLink[kMaxcbmroot_NuTauMudet_ShipRpcPoint];
   ...
   //FairMultiLinkedData TargetPoint_fLink[kMaxcbmroot_Target_TargetPoint];
   ...
   //FairMultiLinkedData TTPoint_fLink[kMaxcbmroot_TargetTracker_TTPoint];
   ...
   //FairMultiLinkedData HptPoint_fLink[kMaxcbmroot_Hpt_HptPoint];
   ...
   //FairMultiLinkedData strawtubesPoint_fLink[kMaxcbmroot_strawtubes_strawtubesPoint];
   ...
   //FairMultiLinkedData EcalPoint_fLink[kMaxcbmroot_Ecal_EcalPoint];
   ...
   //FairMultiLinkedData EcalPointLite_fLink[kMaxcbmroot_EcalLite_EcalPointLite];
   ...
   //FairMultiLinkedData HcalPoint_fLink[kMaxcbmroot_Hcal_HcalPoint];
   ...
   //FairMultiLinkedData HcalPointLite_fLink[kMaxcbmroot_HcalLite_HcalPointLite];
   ...
   //FairMultiLinkedData muonPoint_fLink[kMaxcbmroot_muon_muonPoint];
   ...
   // FairMultiLinkedData TimeDetPoint_fLink[kMaxcbmroot_TimeDet_TimeDetPoint];
   ...
   TBranch        *b_strawtubesPoint_fLink;   //!
...
#ifdef ReadSHiPSim_cxx
ReadSHiPSim::ReadSHiPSim(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../file_Martina/Background_Sim_Martina/Background_Sim/nu_mu/elastic/ship.conical.Genie-TGeant4.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../file_Martina/Background_Sim_Martina/Background_Sim/nu_mu/elastic/ship.conical.Genie-TGeant4.root");
      }
...
ReadSHiPSim::~ReadSHiPSim()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ReadSHiPSim::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ReadSHiPSim::LoadTree(Long64_t entry)
{
...
void ReadSHiPSim::Init(TTree *tree)
{
   ...
   //fChain->SetBranchAddress("ShipRpcPoint.fLink", ShipRpcPoint_fLink, &b_ShipRpcPoint_fLink);
   ...
   //fChain->SetBranchAddress("TargetPoint.fLink", &TargetPoint_fLink, &b_TargetPoint_fLink);
   ...
   //fChain->SetBranchAddress("TTPoint.fLink", TTPoint_fLink, &b_TTPoint_fLink);
   ...
   //fChain->SetBranchAddress("HptPoint.fLink", HptPoint_fLink, &b_HptPoint_fLink);
   ...
   //fChain->SetBranchAddress("strawtubesPoint.fLink", strawtubesPoint_fLink, &b_strawtubesPoint_fLink);
   ...
   //fChain->SetBranchAddress("EcalPoint.fLink", &EcalPoint_fLink, &b_EcalPoint_fLink);
   ...
   //fChain->SetBranchAddress("EcalPointLite.fLink", EcalPointLite_fLink, &b_EcalPointLite_fLink);
   ...
   //fChain->SetBranchAddress("HcalPoint.fLink", &HcalPoint_fLink, &b_HcalPoint_fLink);
   ...
   //fChain->SetBranchAddress("HcalPointLite.fLink", HcalPointLite_fLink, &b_HcalPointLite_fLink);
   ...
   //fChain->SetBranchAddress("muonPoint.fLink", muonPoint_fLink, &b_muonPoint_fLink);
   ...
   //fChain->SetBranchAddress("TimeDetPoint.fLink", TimeDetPoint_fLink, &b_TimeDetPoint_fLink);
...
void ReadSHiPSim::Show(Long64_t entry)
{
...
Int_t ReadSHiPSim::Cut(Long64_t entry)
{
