...
void residualfit_resolution_full()
{
  TFile *inputfile = TFile::Open("checktrackslinearfits25.root"); ///home/scanner/sndlhc/SNDCosmics/checktrackslinearfits.root
...
void anglefit_full(){
  ...
  c_x.SaveAs("gausfit_angx25.root");
  //TCanvas cfitresults;
  //hcorr->Draw("colz");
  ...
  c_y.SaveAs("gausfit_angy25.root");
}
