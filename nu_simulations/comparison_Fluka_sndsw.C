...
void comparison_Fluka_sndsw(){
 ...
 auto hxy_fluka = FLUKAsim.Histo2D({"hxy_fluka","Neutrinos xy distribution from FLUKA;x[cm];y[cm]",200,-100,100,200,-100,100},"x","y","weight");

 auto hcosxy_fluka = FLUKAsim.Histo2D({"hcosxy_fluka","Neutrino angles from FLUKA:x_cos;y_cos",400,-0.2,0.2,400,-0.2,0.2},"x_cos","y_cos","weight");
 //***********************sndsw simulation**********************
 ...
 auto hxy_sndsw = SNDSWsim_full.Histo2D({"hxy_sndsw","Neutrinos xy distribution from SNDSW;x[cm];y[cm]",200,-100,100,200,-100,100},"nux","nuy","w");

 auto hcosxy_sndsw = SNDSWsim_full.Histo2D({"hcosxy_fluka","Neutrino angles from FLUKA:x_cos;y_cos",400,-0.2,0.2,400,-0.2,0.2},"nux_cos","nuy_cos","w");
 //***********************plotting histograms*******************
