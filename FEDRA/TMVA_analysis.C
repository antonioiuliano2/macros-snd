...
void prepareTrees(TString filepath){
	...
	TFile	*outFile	= 	TFile::Open("TMVA_in.root","RECREATE");
...
int TMVA_analysis( TString myMethodList = "" )
{
   ...
   dataloader->AddVariable( "maxaperture",	'F' );
   ...
   dataloader->AddSpectator( "brickID",  "brickID", "units", 'I' );
   ...
   dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
                                        "nTrain_Signal=431:nTrain_Background=2376:SplitMode=Random:NormMode=NumEvents:!V" );
