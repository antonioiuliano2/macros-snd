...
path = '/home/simsndlhc/Simulations_sndlhc/sim_fedra/numu_sim_activeemu_10_November_2021_withinefficiency_withmomentum'
out_dir = path
...
sim_file = path+'/sndLHC.Genie-TGeant4.root'
if os.path.isfile(vtx_file):
    #save vertices in root file
    outputFile = r.TFile(out_dir+"/vertex_sigmu_{}.root".format(brickID),"RECREATE")	
